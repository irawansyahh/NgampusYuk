 ...
 * @author Irawansyah
 */
public class controllerDeskripsiESTP extends MouseAdapter implements ActionListener { 
    private viewDeskripsiESTP view;
    
    public controllerDeskripsiESTP(){
        view = new viewDeskripsiESTP();
