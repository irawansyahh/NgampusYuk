 ...
 * @author Irawansyah
 */
public class controllerDeskripsiESTJ extends MouseAdapter implements ActionListener { 
    private viewDeskripsiESTJ view;
    
    public controllerDeskripsiESTJ(){
        view = new viewDeskripsiESTJ();
