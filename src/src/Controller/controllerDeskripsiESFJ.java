 ...
 * @author Irawansyah
 */
public class controllerDeskripsiESFJ extends MouseAdapter implements ActionListener { 
    private viewDeskripsiESFJ view;
    
    public controllerDeskripsiESFJ(){
        view = new viewDeskripsiESFJ();
