 ...
 * @author Irawansyah
 */
public class controllerDeskripsiISFP extends MouseAdapter implements ActionListener { 
    private viewDeskripsiISFP view;
    
    public controllerDeskripsiISFP(){
        view = new viewDeskripsiISFP();
