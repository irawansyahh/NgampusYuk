 ...
 * @author Irawansyah
 */
public class controllerDeskripsiINTP extends MouseAdapter implements ActionListener { 
    private viewDeskripsiINTP view;
    
    public controllerDeskripsiINTP(){
        view = new viewDeskripsiINTP();
