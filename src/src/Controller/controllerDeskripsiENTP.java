 ...
 * @author Irawansyah
 */
public class controllerDeskripsiENTP extends MouseAdapter implements ActionListener { 
    private viewDeskripsiENTP view;
    
    public controllerDeskripsiENTP(){
        view = new viewDeskripsiENTP();
