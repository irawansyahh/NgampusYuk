 ...
 * @author Irawansyah
 */
public class controllerDeskripsiISTJ extends MouseAdapter implements ActionListener { 
    private viewDeskripsiISTJ view;
    
    public controllerDeskripsiISTJ(){
        view = new viewDeskripsiISTJ();
