 ...
 * @author Irawansyah
 */
public class controllerAnnoucement3 extends MouseAdapter implements ActionListener {
    private viewAnnouncement3 view;
    
    public controllerAnnoucement3(){
        view = new viewAnnouncement3();
