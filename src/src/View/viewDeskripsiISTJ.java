...
public class viewDeskripsiISTJ extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiISTJ() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ISTJ (Ahli Logistik)");
        ...
        jLabel8.setText("Polisi, Dokter, Programmer, Bidang manajemen, ");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/istj.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("Sistem Analis, Akuntan, Inteljen, Pemimpin militer");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Soedirman (Panglima Jenderal)");
