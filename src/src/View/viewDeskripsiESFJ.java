...
public class viewDeskripsiESFJ extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiESFJ() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ESFJ (Sang Konsul)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Ekstrovert Sensing Feeling Judging)");
        ...
        jLabel8.setText("perencana keuangan, perawat, guru, konselor, administratif ");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/esfj.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("pekerjaan yang berkaitan dengan anak-anak");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Kak Seto (psikolog, pemerhati anak)");
