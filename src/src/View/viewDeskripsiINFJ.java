...
public class viewDeskripsiINFJ extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiINFJ() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("INFJ (Sang Advokat)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Introvert Intuition Feeling Judging)");
        ...
        jLabel8.setText("Fotografer, Child care, Seniman, Psikolog, Konselor, ");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/infj.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("Dokter, Pengajar, Designer");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Elly Risman (psikolog)");
