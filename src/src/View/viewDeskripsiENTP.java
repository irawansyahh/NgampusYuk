...
public class viewDeskripsiENTP extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiENTP() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ENTP (Sang Pengdebat)");
        ...
        jLabel8.setText("pengacara, psikolog, konsultan, ilmuwan, aktor");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/entp.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("marketing, progammer, fotografer.");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Hotman Paris Hutapea (Pengacara)");
