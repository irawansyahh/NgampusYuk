...
public class viewDeskripsiINTJ extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiINTJ() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("INTJ (Sang Arsitek)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Introvert Intuitive Thinking Judging)");
        ...
        jLabel8.setText("Hakim, Pengacara, Peneliti, Ilmuwan, Insinyur,Sistem Analis");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/intj.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("Insinyur,Penggajar,Profesor,Dokter,Peneliti,Arsitek");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Albert Enstein(Peneliti)");
