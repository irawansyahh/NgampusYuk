...
public class viewDeskripsiESTP extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiESTP() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ESTP (Sang Pengusaha)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Ekstrovert  Sensing Thinking Perceiving)");
        ...
        jLabel8.setText("marketing, sales, polisi, entrepreneur, pialang saham,");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/estp.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText(" technical support");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Mark zuckerberg (enterpreneur)  ");
