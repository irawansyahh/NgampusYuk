...
public class viewDeskripsiINTP extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiINTP() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("INTP (Ahli Logika)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Introvert Intuition Thinking Perceiving)");
        ...
        jLabel8.setText("Jaksa, Pengacara, Teknisi, Ilmuwan, Fotografer,Sistem Analis");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/intp.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("Sistem analis, Ahli komputer, Ahli Forensik");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Elza Syarief (Pengacara)");
