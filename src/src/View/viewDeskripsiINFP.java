...
public class viewDeskripsiINFP extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiINFP() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("INFP (Sang Mediator)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Introvert Intuitive Feeling Judging)");
        ...
        jLabel8.setText("Rohaniwan, Penulis, Sastrawan, Psikolog, Konselor, Pengajar,");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/infp.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("Seniman  ");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Chairil Anwar (Sastrawan)  ");
