 ...
 * @author 2 Irawansyah
 * @author 3 Irsyad Muhamad Al Anshori
 * 
 */

public class viewDeskripsiESTJ extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiESTJ() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ESTJ (Sang Eksekutif)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Ekstrovert  Sensing Thinking Judjing)");
        ...
        jLabel8.setText("militer, manajer, polisi, hakim, pengacara, ");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/estj.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("guru, sales, auditor, akuntan");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("chairil Tanjung (CEO)");
