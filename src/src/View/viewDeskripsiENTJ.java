...
public class viewDeskripsiENTJ extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiENTJ() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ENTJ (Sang Komandan)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Ekstrovert Intuitive Thinking Judging)");
        ...
        jLabel8.setText("entrepreneur, pengacara, hakim, konsultan, ");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/entj.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("pemimpin organisasi, perencana keuangan");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Ridwan Kamil (pemimpin daerah)");
