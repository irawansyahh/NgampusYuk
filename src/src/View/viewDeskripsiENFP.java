...
public class viewDeskripsiENFP extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiENFP() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ENFP (Juru Kampanye)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Extrovert Intuitive Feeling Perceiving)");
        ...
        jLabel8.setText("konselor, psikolog, entertainer, pengajar, motivator,");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/enfp.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("presenter, reporter, MC, seniman");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Oprah Winfrey (presenter)");
