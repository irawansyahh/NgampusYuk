...
public class viewDeskripsiISTP extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiISTP() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ISTP (Viruoso)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Introvert Sensing Thinking Perceiving)");
        ...
        jLabel8.setText("Ahli forensik, Teknisi, Mekanik, Pilot, Polisi, Programmer");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/istp.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("Entreupreneur, Ahli komputer, Sistem analis, Insinyur");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Dennis E Fitch (Pilot)");
