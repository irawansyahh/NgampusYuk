...
public class viewDeskripsiISFJ extends javax.swing.JFrame {

    /**
     * Creates new form vDeskripsiINTJ
     */
    public viewDeskripsiISFJ() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ISFJ (Sang Pembela)");

        jLabel6.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel6.setText("(Introvert Sensing Feeling Judging)");
        ...
        jLabel8.setText("Perhotelan, Konselor, Administratif, Arsitek, Perawat, ");

        ButtonOk.setText("Back To Menu");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/HasilTest/isfj.png"))); // NOI18N

        jLabel9.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel9.setText("Interior designer, Back Office Manager, Dokter");

        jLabel10.setFont(new java.awt.Font("Gill Sans MT", 0, 14)); // NOI18N
        jLabel10.setText("Syaifoel Hardy (perawat)");
